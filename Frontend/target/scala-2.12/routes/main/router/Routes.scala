...
class Routes(
  ...
  // @LINE:12
  PositionController_1: controllers.PositionController,
  // @LINE:18
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:18
    Assets_0: controllers.Assets
  ) = this(errorHandler, HomeController_2, PositionController_1, Assets_0, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_2, PositionController_1, Assets_0, prefix)
  }
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """createPosition""", """controllers.PositionController.createPosition()"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """register""", """controllers.HomeController.signupHandler()"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """create""", """controllers.PositionController.positionHandler()"""),
  ...
  // @LINE:12
  private[this] lazy val controllers_PositionController_createPosition3_route = Route("GET",
  ...
  private[this] lazy val controllers_PositionController_createPosition3_invoker = createInvoker(
    PositionController_1.createPosition(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  // @LINE:15
  private[this] lazy val controllers_PositionController_positionHandler5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("create")))
  )
  private[this] lazy val controllers_PositionController_positionHandler5_invoker = createInvoker(
    PositionController_1.positionHandler(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.PositionController",
      "positionHandler",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:12
    case controllers_PositionController_createPosition3_route(params@_) =>
      call { 
        controllers_PositionController_createPosition3_invoker.call(PositionController_1.createPosition())
      }
    ...
    // @LINE:15
    case controllers_PositionController_positionHandler5_route(params@_) =>
      call { 
        controllers_PositionController_positionHandler5_invoker.call(PositionController_1.positionHandler())
      }
