...
package controllers.javascript {
  ...
  class ReversePositionController(_prefix: => String) {
    ...
    // @LINE:12
    def createPosition: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.PositionController.createPosition",
      """
        function() {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "createPosition"})
        }
      """
    )
  
    // @LINE:15
    def positionHandler: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.PositionController.positionHandler",
      """
        function() {
